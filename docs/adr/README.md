...
| [0015](0015-defer-crates-io-distribution.md)   | Defer crates.io; git-install + GitHub Release binaries (amends 0004)  | Accepted |
...
| [0019](0019-stateless-connection-layer.md)     | Stateless connection layer for MCP 2026-07-28                        | Proposed |
| [0020](0020-publish-to-crates-io.md)           | Publish to crates.io at next release (supersedes 0015 once executed)  | Proposed |
